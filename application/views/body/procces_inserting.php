  ...
  <div class="content">
    <div class="container-fluid">
		 ...
		 <div class="col-md-6">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Finish Inserting</h4>
              </div>
              <div class="card-body">
      ...
      <div class="col-md-6">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Reject Inserting</h4>
              </div>
              <div class="card-body">
              <form method="post" action="<?php echo base_url();?><?php echo $reject_job;?>" class="form-horizontal">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <select class="selectpicker" data-size="7" data-style="select-with-transition" title="REJECT INSERTING" name="reject_inserting" id="reject_inserting" >
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h4 class="card-title">INSERTING</h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                  ...
                  <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                      <?php $no = 0; foreach($get_inserting as $row) : $no++;?>
                      <?php 
                      if($row->inserting_status==='reject'){
                        $colour = 'red';
                        $info = 'Reject';
                      }else{
                        $colour = 'blue';
                        ...
                        <tr>
                            ...
                            <td><?php echo $row->inserting_reject;?></td>
                            <td class="text-center">
                            <a href="<?php echo base_url();?>procces_inserting/edit_procces/<?php echo $row->id_log_summary_dnr_detail;?>" class="btn btn-link btn-success edit">Finish</a>
                        </td>
                        </tr>
                        <?php endforeach;?>
                      </tbody>
