        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              ...
              <h4 class="card-title">Finish Balancing</h4>
              </div>
              <div class="card-body">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <form method="post" action="<?php echo base_url();?><?php echo $finish_jobs;?>" class="form-horizontal">
                    ...
                    <div class="row">
                      <label class="col-sm-4 col-form-label">Menolak Job</label>
                      <div class="col-sm-3">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h4 class="card-title">BALANCING</h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                  ...
                  <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                      <?php $no = 0; foreach($get_balancing as $row) : $no++;?>
                        <tr>
                            ...
                            <a class="btn btn-link btn-success edit" href="<?php echo base_url();?>procces_balancing/edit_procces/<?php echo $row->id_log_summary_dnr_detail;?>">Finish</a>
                        </td>
                        </tr>
                        <?php endforeach;?>
                      </tbody>
