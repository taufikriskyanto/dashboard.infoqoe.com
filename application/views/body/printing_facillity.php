            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  <div class="card-icon">
                  <img src="<?php echo base_url();?>assets/img/icons/baseline_print_white_18x2dp.png">
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                      <?php $no = 0; foreach($get_printing_facillity as $row) : $no++;?>
                        <tr>
                            ...
                            <!-- <a  href="<?php echo base_url();?>facillity/edit_printing/<?php echo $row->id_surat_order;?>"  class="btn btn-link btn-success finish" >Finish</a>
                            <a  href="<?php echo base_url();?>facillity/printing_reject/<?php echo $row->id_surat_order;?>" class="btn btn-link btn-danger remove">Tolak</a> -->
                            <a  href="<?php echo base_url();?>facillity/edit_printing/<?php echo $row->id_surat_order;?>"><i class="material-icons">local_printshop</i></a>
                            <a  href="<?php echo base_url();?>facillity/view_printing/<?php echo $row->id_surat_order;?>"><i class="material-icons">visibility</i></a>
                            <a  href="<?php echo base_url();?>facillity/printing_reject/<?php echo $row->id_surat_order;?>"><i class="material-icons">report</i></a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                      </tbody>
