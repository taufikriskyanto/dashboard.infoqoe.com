...
<BODY class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('<?php echo base_url(); ?>assets/img/astragraphia.png'); background-size: cover; background-position: top center;">
        ...
        <div class="row">
          ...
          <form action="<?php echo base_url();?>login/login_akses" method="post">
              <div class="card card-login card-hidden">
                ...
                <div class="card-body ">
                  <p class="card-description text-center">PT Astragraphia Xprins Indonesia</p>
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input class="form-control my-password" placeholder="Password" name="password" type="password" required>
                    </div>
                  </span>
                </div>
                <div class="row">
                      ...
                      <div class="col-md-9">
                        <div class="form-check">
                          <label class="form-check-label">
                            <input class="form-check-input showPassword" type="checkbox">Show Password
